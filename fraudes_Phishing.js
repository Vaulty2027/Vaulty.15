...
// ------------------------------------------------------------------
// Cualquier elemento con la clase ".reveal" (tarjetas de "Ejemplos más
// comunes", tips de "Cómo protegerte", bloques de "Qué hacer si eres
// víctima", "Mitos y realidades" y "Sitio web falso") empieza oculto
// por CSS y se le agrega ".reveal-visible" apenas entra en pantalla.
// Si el navegador no soporta IntersectionObserver, se muestran todos
// de una vez para no dejar contenido invisible.
// ============================================
(() => {
...
// ============================================
// CHECKLIST — "¿Qué hacer si eres víctima?"
// ------------------------------------------------------------------
// La lista es informativa (icono de check fijo por CSS): ya NO se puede
// marcar/desmarcar con click, solo se muestra como pasos recomendados.
// ============================================
