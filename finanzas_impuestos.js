...
function setLang(lang) {
    ...
    // Cambia imágenes con data-img-es / data-img-en (usado en
    // .quien-img y en .contribucion-img)
...
observar('.consejo-card');
observar('.forma-card', 100);
observar('.entidad-banco-card', 60);
