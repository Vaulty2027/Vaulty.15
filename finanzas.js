...
// ============================================
// BOTONES DE LAS TARJETAS — efecto ripple al hacer click
// ============================================
document.querySelectorAll('.card-title').forEach(button => {
    button.addEventListener('click', function (e) {
        ...
        // El círculo debe ser lo bastante grande para cubrir todo el botón
        ...
        // Al terminar la animación, quitamos el círculo y navegamos a la página
        setTimeout(() => {
            ripple.remove();
