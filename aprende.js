...
// ASISTENTE — Strix
// ------------------------------------------------------------------
// El HTML trae el botón flotante (#strix-btn), la ventana de chat
// (#chat) y el contenedor de preguntas (#preguntas), pero no tenían
// ningún JS que los hiciera funcionar. Este bloque los conecta:
// arma los botones de preguntas frecuentes y abre/cierra el chat.
// ============================================
const preguntasStrix = [
    {
...
if (strixBtn && cerrarChat && asistente && preguntasDiv && mensajesDiv) {
    ...
    // Armar los botones de preguntas frecuentes
    preguntasStrix.forEach(item => {
